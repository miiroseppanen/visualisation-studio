...
interface AnimationControlsProps {
  settings: FractalTreeAnimationSettings
  onSettingsChange: (updates: Partial<FractalTreeAnimationSettings>) => void
  onReset: () => void
  expanded: boolean
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            onValueChange={(value) => onSettingsChange({ growthSpeed: value[0] })}
            max={0.05}
            min={0.001}
            step={0.001}
            className="w-full"
