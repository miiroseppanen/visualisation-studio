...
interface H23LogoProps {
  className?: string
  size?: 'sm' | 'md' | 'lg'
}

export function H23Logo({ className, size = 'md' }: H23LogoProps) {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8'
